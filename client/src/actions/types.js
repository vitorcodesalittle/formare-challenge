...
export const SEARCH_USER_STARTED = STARTED(SEARCH_USER);
export const SEARCH_USER_SUCCESS = SUCCESS(SEARCH_USER);
export const SEARCH_USER_FAILED = FAILED(SEARCH_USER);
